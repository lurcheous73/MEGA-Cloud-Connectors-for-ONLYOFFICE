...
{
    internal sealed class BrimstoneMegaCloudSecurityDao : BrimstoneMegaCloudDaoBase, ISecurityDao
    {
        public BrimstoneMegaCloudSecurityDao(BrimstoneMegaCloudDaoSelector.BrimstoneMegaCloudInfo info,
