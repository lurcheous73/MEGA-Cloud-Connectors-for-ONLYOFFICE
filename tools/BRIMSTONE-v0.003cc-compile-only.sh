...
BRANCH="v0.003cc-mega-cloud-live-path"
...
preflight(){
    echo "=== BRIMSTONE MEGA CLOUD v0.003cc COMPILE-ONLY PREFLIGHT ==="
...
grep -Fq 'Brimstone MEGA Cloud v0.003cc is read-only.' <<<"$STRINGS"
...
CHECK
    ...
    echo
    echo "=== BRIMSTONE MEGA CLOUD v0.003cc COMPILE-ONLY PASS ==="
    sha256sum "$CANDIDATE"
